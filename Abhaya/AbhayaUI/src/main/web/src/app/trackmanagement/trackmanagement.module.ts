...
import { TrackmanagementRoutingModule } from './trackmanagement-routing.module';
...
@NgModule({
    declarations: [TrackdeviceComponent, TripcreateComponent, TripdetailsComponent, RoutedeviationComponent],
    imports: [
        CommonModule,
        NgbModule,
        FormsModule,
