...
import { DevicedetailsComponent } from '../devicemanagement/devicedetails/devicedetails.component';
import { UserdetailsComponent } from '../usermanagement/userdetails/userdetails.component';
import { PacketdetailsComponent } from '../devicemanagement/packetdetails/packetdetails.component';
import { AddeditvehicleComponent } from '../vehiclemanagement/addeditvehicle/addeditvehicle.component';
import { VehiclemappingComponent } from '../vehiclemanagement/vehiclemapping/vehiclemapping.component';
import { AddeditsystempropComponent } from '../systemmanagement/addeditsystemprop/addeditsystemprop.component';
import { ViewcommanddetailsComponent } from '../commandmanagement/viewcommanddetails/viewcommanddetails.component';
...
@NgModule({
    declarations: [CoreComponent, LoginComponent, SidemenuComponent, HeaderComponent,
        ...
        DevicedetailsComponent, UserdetailsComponent, PacketdetailsComponent, AddeditvehicleComponent,
        VehiclemappingComponent, AddeditsystempropComponent, ViewcommanddetailsComponent],
    imports: [
        CommonModule,
        CoreRoutingModule,
        FormsModule,
